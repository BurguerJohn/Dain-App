...
//    printf("I am here\n");
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(input1.type(), "DepthFlowProjection_gpu_forward", ([&] {
...
//    printf("I am there\n");
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(input1.type(), "DepthFlowProjectionAveraging", ([&] {
...
//        printf("use flow fill hole\n");
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(input1.type(), "DepthFlowFillhole", ([&] {
        ...
        )
{
    ...
    if(BLOCKDIMX != 32 || BLOCKDIMY != 16||DEBUG)
        printf("BLOCKDIMX revised to %d, BLOCKDIMY revised to %d \n", BLOCKDIMX,BLOCKDIMY);
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(input1.type(), "DepthFlowProjection_gpu_backward", ([&] {
